...
def detect(img, cascade):
    rects = cascade.detectMultiScale(img, scaleFactor=1.3, minNeighbors=3, minSize=(
...
def main():
    ...
    dog_img = cv2.imread("dogfilter.png")
    # dog_img = cv2.imread("large.png")
    dalmatian_img = cv2.imread("dalmatianfilter.png")
