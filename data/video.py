...
# local modules
from data  import tst_scene_render
...
class Book(VideoSynthBase):
    def __init__(self, **kw):
        ...
        self.render = tst_scene_render.TestSceneRender(backGr, fgr, speed = 1)
...
class Cube(VideoSynthBase):
    def __init__(self, **kw):
        ...
        self.render = tst_scene_render.TestSceneRender(cv2.imread('../data/pca_test1.jpg'), deformation = True,  speed = 1)
